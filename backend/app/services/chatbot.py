    ...
    def __init__(self):
        ...
        self.combine_docs_prompt = ChatPromptTemplate.from_messages([
            SystemMessagePromptTemplate.from_template(
                ...
                "- A moins que la conversation soit vide, ne fais pas comme si c'était ton premier message (exemple : ne dis pas bonjour si tu vois que tu l'as déjà dit).\n"
                "- Répond uniquement au dernier message de l'utilisateur.\n"
                "- Parle en français et de manière pédagogique.\n"
                "- Utilise les ressources externes fournies si et seulement si c'est pertinent pour répondre à l'utilisateur (ne te focalise pas dessus).\n"
